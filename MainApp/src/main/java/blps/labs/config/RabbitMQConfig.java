...
public class RabbitMQConfig {
    ...
    private String addReviewQueueName="addReviewQueue";
    //@Value("${rabbitmq.check-review-queue}")
    private String checkReviewQueueName="checkReviewQueue";
    //@Value("${rabbitmq.send-spam-queue}")
    private String sendSpamQueueName="sendSpamQueue";
    //@Value("${rabbitmq.app-exchange}")
    private String exchange="app-exchange";
   // @Value("${rabbitmq.add-review-routingKey}")
    private String addReviewRoutingKey="addReviewRoutingKey";
   // @Value("${rabbitmq.check-review-routingKey}")
    private String checkReviewRoutingKey="checkReviewRoutingKey";
